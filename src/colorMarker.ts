...
export function markHighlight(
	...
	switch (colorToHex(color)) {
		...
		case "#A28AE5": return `#️⃣ ${text}`;  // purple — header
		case "#5FB236": return `[[${text}]]`;  // green — concept/entity wikilink
		default: return text;                   // unknown colour — leave as-is
	}
}
